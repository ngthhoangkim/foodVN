  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: 'url(assets/img/home-bg.png)', backgroundSize: 'cover', backgroundPosition: 'center', height: '500px' }}>
        <div className="absolute inset-0 bg-black opacity-50 z-10"></div>
        <div className="w-full space-y-5 z-20 relative flex flex-col items-center">
          <h1 className="text-[#FABC3F] font-semibold text-6xl text-center" style={{ lineHeight: '1.5', letterSpacing: '0.05em' }}>
